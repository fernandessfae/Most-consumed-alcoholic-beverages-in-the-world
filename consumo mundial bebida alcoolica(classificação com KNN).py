...
'''Aqui ulitizaremos o método de classificação com KNN, para ver se eles acertam a bebida marjoritária de cada país. '''
...
'''Agora vamos treinar o algoritmo knn, ajustando o número de vizinhos e usar a base de treinamento para treinar o modelo
   ...
   existe 4 grupos, o mais sensato é colocar n = 4. '''
...
'''Obs³: Para efeito de comparação, decidi ajustar o teste_size para ver quais valores seriam melhor para o teste de árvore de decisão da máquina, e o resultado foi esse:
         ...
         Como constatado, a taxa de acerto foi 91.4%, aproximadamente, com 30% de dados para teste com todos os 193 países.
         Como constatado, a taxa de acerto foi 91.1%, aproximadamente, com 29% de dados para teste com todos os 193 países.
         Como constatado, a taxa de acerto foi 90.9%, aproximadamente, com 28% de dados para teste com todos os 193 países.
         Como constatado, a taxa de acerto foi 90.6%, aproximadamente, com 27% de dados para teste com todos os 193 países.
         Como constatado, a taxa de acerto foi 90.2%, aproximadamente, com 26% de dados para teste com todos os 193 países.
         Como constatado, a taxa de acerto foi 91.8%, aproximadamente, com 25% de dados para teste com todos os 193 países.
         Como constatado, a taxa de acerto foi 91.5%, aproximadamente, com 24% de dados para teste com todos os 193 países.
         Como constatado, a taxa de acerto foi 93.3%, aproximadamente, com 23% de dados para teste com todos os 193 países.
         Como constatado, a taxa de acerto foi 93.0%, aproximadamente, com 22% de dados para teste com todos os 193 países.
         Como constatado, a taxa de acerto foi 95.1%, aproximadamente, com 21% de dados para teste com todos os 193 países.
         Como constatado, a taxa de acerto foi 94.9%, aproximadamente, com 20% de dados para teste com todos os 193 países.
         
         Conclusão, o melhor resultado da máquina foi um valor de 0.21(21%) dos dados para o teste e 0.79(79%) dos dados para treinamento. A conclusão que se
